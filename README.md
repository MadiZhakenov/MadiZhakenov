...
### 📂 Проекты на 2025-2026

| Проект | Описание | Стек | Ссылки |
|---|---|---|---|
| **ToneMatch AI** | VST3-плагин на базе ИИ для автоматического клонирования гитарного звука с аудио-референса. Система использует нейросетевое моделирование (NAM) и многокритериальную оптимизацию для подбора идеального пресета из библиотеки в 260+ моделей. | `C++`, `JUCE`, `Python`, `PyTorch`, `NAM`, `Librosa`, `Scipy` | [GitHub](https://github.com/MadiZhakenov/tonematch-ai) |
...
| **NeoDom (OSI SaaS Platform)** | Full-stack SaaS-платформа в сфере ЖКХ (ОСИ) с AI-ассистентом и RAG-пайплайном для стабильного семантического поиска и генерации ответов. | `NestJS`, `PostgreSQL`, `React`, `TypeScript`, `Gemini`, `LangChain`, `JWT`, `Docker` | [GitHub](https://github.com/MadiZhakenov/neo-dom) |
...
| **AI Curriculum Generator** | Десктопное приложение, которое автоматизирует создание годовых учебных планов для дошкольных учреждений, сокращая время работы с недель до минут. | `Python`, `Gemini`, `RAG`, `Tkinter` | [GitHub](https://github.com/MadiZhakenov/ai-curriculum-generator) <br/> [YouTube](https://youtu.be/jAyTPZ_wfXo) |
